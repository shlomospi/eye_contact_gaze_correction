...
model_config.add_argument('--uid', type=str, default='input', help='')
model_config.add_argument('--P_IDP', type=eval, default=6.3, help='distance between eyes, cm'
                                                                  '')
model_config.add_argument('--f', type=eval, default=444, help='')
model_config.add_argument('--P_c_x', type=eval, default=0, help='')
model_config.add_argument('--P_c_y', type=eval, default=-19, help='')
model_config.add_argument('--P_c_z', type=eval, default=0, help='')
model_config.add_argument('--S_W', type=eval, default=60, help='')
model_config.add_argument('--S_H', type=eval, default=34, help='')
